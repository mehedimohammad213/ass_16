        ...
        <div>
            <nav className='relative px-6 py-6 flex justify-between items-center bg-white'>
                ...
                <ul className='hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6'>
                    ...
                    <li>
                        <Link className={current==="/testimonials"?"text-sm text-green-600 font-bold":"text-sm text-gray-400 hover:text-gray-500 ring-2 ring-green-300 "}  href={'/testimonials'}>Login</Link>
                    </li>
                    <li>
                        <Link className={current==="/testimonials"?"text-sm text-green-600 font-bold":"text-sm text-gray-400 hover:text-gray-500 ring-2 ring-green-300 bg-green-300 "}  href={'/testimonials'}>Register</Link>
                    </li>
                </ul>
            </nav>
